...
module.exports.sendPdfToStudent = async (req: any, res: any) => {
     try {
...
module.exports.getAllSchools = async (req: any, res: any) => {
     try {
...
module.exports.getAllStudents = async (req: any, res: any) => {
     try {
